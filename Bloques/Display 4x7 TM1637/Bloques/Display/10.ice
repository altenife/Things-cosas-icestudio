{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "4d66df77-96f7-4b8f-b6c3-e49e9d8a0122",
          "type": "basic.input",
          "data": {
            "name": "",
            "pins": [
        ...
        {
          "id": "ea90b360-ad77-4144-96ce-e76174f2682f",
          "type": "basic.input",
          "data": {
            "name": "in End Tic",
            "pins": [
        ...
        {
          "id": "22f7b29a-c17d-4dc3-a69d-b2ed6da8d87c",
          "type": "basic.output",
          "data": {
            "name": "Out",
            "pins": [
        ...
        {
          "id": "7bc6a1f8-5efe-4d48-8366-429d26adb8b2",
          "type": "basic.constant",
          "data": {
            "name": "T4 Display",
            "value": "5",
        ...
        {
          "id": "a2c31689-c9bb-4fbd-b40f-adb48705be7e",
          "type": "basic.constant",
          "data": {
            "name": "T4 Display",
            "value": "16",
        ...
        {
          "id": "53d8cc5f-d472-426d-b009-1ce47fb5d149",
          "type": "basic.constant",
          "data": {
            "name": "T4 Display",
            "value": "81",
        ...
        {
          "id": "315ac236-5f49-47b2-89f0-caff4960462c",
          "type": "basic.constant",
          "data": {
            "name": "T4 Display",
            "value": "42",
        ...
        {
          "id": "af81a5f3-0180-440d-b192-12428aa15ca1",
        ...
        {
          "id": "fcdba220-1fb4-4095-8007-b514401108cc",
          "type": "20bf02b187352922e3e7d0fbcfa52f4fc86282a2",
          "position": {
            "x": 464,
            "y": 248
        ...
        {
          "id": "fcca6ced-8e33-4624-958c-5d4424af6d54",
          "type": "basic.info",
          "data": {
            "info": "Display 2. 10",
            "readonly": true
        ...
        {
          "id": "0ca7ad2c-e064-4d21-ae7a-4f825e323841",
          "type": "20bf02b187352922e3e7d0fbcfa52f4fc86282a2",
          "position": {
            "x": 664,
            "y": 240
        ...
        {
          "id": "eddda1c0-54df-44db-9b8c-cd43b9fe5199",
          "type": "20bf02b187352922e3e7d0fbcfa52f4fc86282a2",
          "position": {
            "x": 880,
            "y": 240
        ...
        {
          "id": "e004cff2-5a5d-4f27-98eb-d6a56162b50d",
      ...
      "wires": [
        {
          "source": {
            "block": "7bc6a1f8-5efe-4d48-8366-429d26adb8b2",
            "port": "constant-out"
          },
          "target": {
            "block": "af81a5f3-0180-440d-b192-12428aa15ca1",
        ...
        {
          "source": {
            "block": "a2c31689-c9bb-4fbd-b40f-adb48705be7e",
            "port": "constant-out"
          },
          "target": {
            "block": "fcdba220-1fb4-4095-8007-b514401108cc",
            "port": "7ca578e5-8e36-4c04-bbea-144418c8e9af"
          },
          "vertices": []
        },
        {
          "source": {
            "block": "4d66df77-96f7-4b8f-b6c3-e49e9d8a0122",
            "port": "out"
          },
          "target": {
            "block": "af81a5f3-0180-440d-b192-12428aa15ca1",
        ...
        {
          "source": {
            "block": "ea90b360-ad77-4144-96ce-e76174f2682f",
            "port": "out"
          },
          "target": {
            "block": "af81a5f3-0180-440d-b192-12428aa15ca1",
        ...
        {
          "source": {
            "block": "53d8cc5f-d472-426d-b009-1ce47fb5d149",
            "port": "constant-out"
          },
          "target": {
            "block": "0ca7ad2c-e064-4d21-ae7a-4f825e323841",
            "port": "7ca578e5-8e36-4c04-bbea-144418c8e9af"
          },
          "vertices": []
        },
        ...
        {
          "source": {
            "block": "315ac236-5f49-47b2-89f0-caff4960462c",
            "port": "constant-out"
          },
          "target": {
            "block": "eddda1c0-54df-44db-9b8c-cd43b9fe5199",
            "port": "7ca578e5-8e36-4c04-bbea-144418c8e9af"
          },
          "vertices": []
        },
        ...
        },
        {
          ...
          "target": {
            "block": "e004cff2-5a5d-4f27-98eb-d6a56162b50d",
        ...
        },
        {
          ...
          "target": {
            "block": "22f7b29a-c17d-4dc3-a69d-b2ed6da8d87c",
            "port": "in"
          }
        },
        {
